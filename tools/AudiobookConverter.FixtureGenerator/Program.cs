...
public static class Program
{
  ...
  public static async Task<int> Main(string[] args)
  {
    ...
    await File.WriteAllTextAsync(Path.Combine(root, "corpus.json"), JsonSerializer.Serialize(new { schemaVersion = "1", generatedBy = "AudiobookConverter.FixtureGenerator", cases }, JsonOptions)).ConfigureAwait(false);
    return 0;
  }
